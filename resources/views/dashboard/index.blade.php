...
<head>
    ...
    <title>Adit Blog | Dashboard</title>
        ...
        <div class="row">
                        ...
                        <ul class="nav flex-column mb-auto">
                            <li class="nav-item">
                                <form action="/logout" method="POST">
                                    @csrf
                                    <button class="nav-link d-flex align-items-center gap-2" type="submit"><svg class="bi" aria-hidden="true"><use xlink:href="#door-closed"></use></svg> Logout</button>
                                </form>
                            </li>
                        </ul>
                    </div>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Welcome Back, Adithya ramadhan</h1>
                </div>
                <canvas
                    class="my-4 w-100"
                    id="myChart"
